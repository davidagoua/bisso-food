...
-- Insert multiple rows into the table `cuisine`. Top 10 World Cuisines

INSERT INTO `cuisine` (`id`, `name`, `image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Italian', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(2, 'Chinese', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(3, 'Indian', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(4, 'French', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(5, 'Japanese', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(6, 'Thai', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(7, 'Mexican', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(8, 'Spanish', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(9, 'Lebanese', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00'),
(10, 'Greek', 'product_default.jpg', 1, '2020-06-01 00:00:00', '2020-06-01 00:00:00');
...
(1, 'english', 'english.json', 'english.png', 'ltr', 1, '2021-02-08 05:42:03', '2021-10-14 10:55:44'),
(2, 'spanish', 'spanish.json', 'spanish.png', 'ltr', 1, '2021-02-08 05:55:04', '2021-10-14 10:55:42');
...
(1, '60', '60', 'order_amount', '[{\"min_value\":\"1\",\"max_value\":\"10\",\"charges\":\"50.50\"},{\"min_value\":\"10\",\"max_value\":\"20\",\"charges\":\"100.50\"}]', '2020-11-01 22:24:57', '2022-01-29 12:56:59');
...
CREATE TABLE `payment_setting` (
  ...
  `is_debbug_mode` tinyint(1) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `payment_setting` (`id`, `cod`, `stripe`, `razorpay`, `paypal`, `flutterwave`, `wallet`, `stripe_publish_key`, `stripe_secret_key`, `paypal_production`, `paypal_sendbox`, `paypal_client_id`, `paypal_secret_key`, `razorpay_publish_key`, `public_key`, `encryption_key`, `is_debbug_mode`, `created_at`, `updated_at`) VALUES
(1, 1, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-10-29 06:09:35', '2022-01-29 13:52:42');
...
CREATE TABLE `promo_code` (
  ...
  `flatDiscount` float DEFAULT NULL,
...
CREATE TABLE `settlements` (
  ...
  `admin_earning` float NOT NULL,
  `vendor_earning` float NOT NULL,
...
(1, 'admin', '60b5c79fe1226.png', 'admin-mealUp@gmail.com', NULL, NULL, '$2y$10$QY7BCiafK3hoHiFWL/2RM.JCwlBpVpDzZLmkIRLNj5cosDMyZtawC', NULL, NULL, 0, 1, 2745, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-11-03 05:51:37', '2021-10-14 10:09:27');
...
--
--  Update Release v4.0.0 : Price, Currency, Tax, Tax Amount Type Change
--
ALTER TABLE `order` CHANGE `amount` `amount` DECIMAL(11,2) NOT NULL;
ALTER TABLE `order` CHANGE `vendor_discount_price` `vendor_discount_price` DECIMAL(11,2) NULL DEFAULT '0';
ALTER TABLE `order` CHANGE `promocode_price` `promocode_price` DECIMAL(11,2) NULL DEFAULT '0';
ALTER TABLE `order_child` CHANGE `price` `price` DECIMAL(11,2) NOT NULL;
ALTER TABLE `promo_code` CHANGE `max_disc_amount` `max_disc_amount` DECIMAL(11,2) NULL DEFAULT NULL;
ALTER TABLE `promo_code` CHANGE `min_order_amount` `min_order_amount` DECIMAL(11,2) NOT NULL;
ALTER TABLE `settlements` CHANGE `payment` `payment` DECIMAL(11,2) NOT NULL;
ALTER TABLE `submenu` CHANGE `price` `price` DECIMAL(11,2) NOT NULL;
ALTER TABLE `tax` CHANGE `tax` `tax` DECIMAL(11,2) NOT NULL;
ALTER TABLE `vendor` CHANGE `min_order_amount` `min_order_amount` DECIMAL(11,2) NULL DEFAULT NULL;
ALTER TABLE `vendor` CHANGE `tax` `tax` DECIMAL(11,2) NULL DEFAULT NULL;
ALTER TABLE `vendor_discount` CHANGE `discount` `discount` DECIMAL(11,2) NOT NULL;
ALTER TABLE `vendor_discount` CHANGE `min_item_amount` `min_item_amount` DECIMAL(11,2) NOT NULL;
ALTER TABLE `vendor_discount` CHANGE `max_discount_amount` `max_discount_amount` DECIMAL(11,2) NOT NULL;
