        ...
        <div class="card">
            <div class="card-header">
                ...
                <div style="width: 110%;">
                    ...
                    <div class="success">
                        <div class="alert-danger text-center">{{ session::get('success')}}</div>
                    </div>
                    @endif
                </div>
                <div class="w-100">
                                        ...
                                        <tr>
                                            ...
                                            @if (Session::get('vendor_driver') == 0)
                                                @if ($order->payment_type == 'COD' && $order->vendor_pending_amount == 0 && $order->order_status == 'COMPLETE')
                                                    <td>{{ $currency }}{{ $order->amount }}</td>
                                                    <td>
                                                        <a onclick="check()" href="{{ url('vendor/deliveryPerson/pending_amount/'.$order->id) }}" class="text-danger myform">{{__('Pending Amount')}}</a>
                                                    </td>
                                                @else
                                                    <td>{{ $currency }}{{00}}</td>
                                                    <td>
