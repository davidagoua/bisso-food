        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a href="{{ url('vendor/vendor_menu') }}">{{ $menu->name }}</a>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="image"
                                    accept=".png, .jpg, .jpeg, .svg" lang="en">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('item_reset_value') is-invalid @enderror"
                                name="item_reset_value" min=1 type="number" placeholder="{{ __('Item Reset Value') }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label">{{ __('Item price') }}<span
                                    class="text-danger">&nbsp;*</span></label>
                            <input class="form-control @error('price') is-invalid @enderror" name="price"
                                type="text" placeholder="{{ __('Item price') }}" id="update_price" required
                                value="{{ old('price') }}">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                @endphp
                <form class="myform" action="{{ url('admin/submenu_import/' . $vendor->id) }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
