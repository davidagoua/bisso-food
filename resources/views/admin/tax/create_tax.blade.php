...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form class="container-fuild myform" action="{{ url('admin/tax') }}" method="post">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-5">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="{{ __('Tax Name') }}" value="{{ old('name') }}" required="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-5">
                                <label for="{{ __('Tax') }}">{{ __('Tax type') }}<span
                                        class="text-danger">&nbsp;*</span></label>
