            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-9">
                    ...
                    <div class="card hide stripe_card">
                        ...
                        <div class="card-body">
                            <form role="form" action="" method="post" class="require-validation customform myform"
                    ...
                    <div class="card hide flutter_card">
                        ...
                        <div class="card-body">
                            <form class="myform" action="{{ url('admin/fluterPayment') }}" method="post">
                                @csrf
                                <input type="hidden" name="vendor" value="{{ $vendor->id }}">
                                <input type="hidden" name="amount" value="{{ $amount }}">
                                <input type="hidden" name="duration" value="{{ $duration }}">
                    ...
                    <div class="card cod_card">
                        ...
                        <div class="card-body">
                            <input type="button" onclick="settlement()" value="{{ __('Pay offline') }}"
