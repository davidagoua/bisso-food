...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form class="container-fuild myform" action="{{ url('admin/language/' . $language->id) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="">{{ __('Name of Language') }}({{ __("cann't edit") }})<span
                                        class="text-danger">&nbsp;*</span></label>
                                <input type="text" name="name"
                                    class="form-control text_transform_none @error('name') is_invalide @enderror"
                                    value="{{ $language->name }}" required="true" readonly>
                                @error('name')
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="">{{ __('Language Json File') }}<span
                                        class="text-danger">&nbsp;*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="">{{ __('Language Direction') }}<span
                                        class="text-danger">&nbsp;*</span></label>
