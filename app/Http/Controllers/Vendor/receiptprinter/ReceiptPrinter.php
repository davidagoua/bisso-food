...
namespace App\Http\Controllers\Vendor\ReceiptPrinter;

use App\Http\Controllers\Vendor\ReceiptPrinter\Item as Item;
use App\Http\Controllers\Vendor\ReceiptPrinter\Store as Store;
...
class ReceiptPrinter
{
    ...
    public function calculateSubtotal() {
        ...
        foreach ($this->items as $item) {
            $this->subtotal +=  number_format($item->getQty() * $item->getPrice(),2);
        }
    }
    ...
    public function calculateGrandTotal() {
        ...
        $this->grandtotal =  number_format($this->subtotal,2) + $this->tax;
    }
    ...
    public function getPrintableSummary($label, $value, $is_double_width = false) {
        ...
        $formatted_value = $this->currency . $value;
    ...
    public function printReceipt($with_items = true) {
        if ($this->printer) {
            ...
            $subtotal = $this->getPrintableSummary('Subtotal', number_format($this->subtotal,2));
            $tax = $this->getPrintableSummary('Tax', number_format($this->tax,2));
